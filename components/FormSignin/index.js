...
export default function FormSignin() {
	...
	const handleSubmit = async () => {
		...
		toast.success("berhasil signin !", {
			position: "top-right",
			autoClose: 5000, // tampil selama 5 detik lalu hilang
		...
		Cookies.set("token", res.data.token); // cookies.set ini digunakan untuk menyimpan token kedalam cookies, 'token' merupakan key nya, value nya adalah dari res.data.token
		router.push("/");
	};
