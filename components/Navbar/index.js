		...
		<nav className="container navbar navbar-expand-lg navbar-dark">
			<div className="container-fluid">
				...
				<div className="collapse navbar-collapse" id="navbarNavAltMarkup">
					...
					{router.pathname !== "/signin" && ( // disini memuat logic yang akan menambah nama user saat sudah login || disini akan dicek, pathname tidak sama signin  jika path betul tidak sama dengan signin maka akan dilanjutkan cek lagi dibawah
						<>
							{token ? (
								/**
								 * Tahap ini akan dicek dahulu tokennya ada atau tidak, jika tokennya ada maka akan menampilkan seluruh form yang ada dibawah ini
								 */
