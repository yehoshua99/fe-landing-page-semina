...
export async function getServerSideProps(context) {
	const req = await getData(`/api/v1/orders`, {}, context.req.cookies.token); // disini juga mengirimkan token dari cookies, tujuannya agar kita mendapat id nya nantinya
