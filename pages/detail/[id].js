...
export default function DetailPage({ detailPage, id }) {
	...
	const handleSubmit = (ticketId, organizer) => {
		//ketika submit, kita akan mengirim parameter tickedId dan organizer, utk mendaptkan ticket dan organizer yang nantinya akan dikitim pakai router /ceckout
				...
				<div className="d-flex flex-wrap justify-content-lg-center gap">
					...
					<div className="d-flex flex-column card-event">
						...
						{detailPage.tickets.map((ticket) => (
							<div key={ticket._id}>
								{ticket.statusTicketCategories ? ( // jika statusTicketCategories nya true maka akan menampilkan form dibawah ini, jika false tidak akan ditampilkan
									<>
										...
										{detailPage.stock !== 0 && (
											<Button
												variant={"btn-green"}
												action={
													() => handleSubmit(ticket._id, detailPage.organizer) // waktu submit, akan mengirim id dari ticket dan organizer dari detailPage
												}
											>
												Join Now
											</Button>
...
/**
 * Untuk mengambil detail dari events nya, kita menggunakan getServerSideProps dan cukup menggunakan context
 */
